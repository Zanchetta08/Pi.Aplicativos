...
<div id="event-create-container" class="col-md-6 offset-md-3">
    <h1>Case 2: {{ $treinamento->nome }}</h1>
    <form action="/treinamentos/case2Update/{{ $treinamento->id }}" method="POST">
        @csrf
        @method('PUT')
        ...
        <input type="submit" class="btn btn-primary" value="Finalizar Case 2">
    </form>
</div>
